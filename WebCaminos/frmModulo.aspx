<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="frmModulo.aspx.cs" Inherits="WebSISCON.frmModulo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <h1 id="hTitulo" class="titulos" style="margin-right: 10px; padding-top: 27px">Formulario de Registro de Modulos para Proyectos</h1>
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false" Height="150px">
                <div id="DatosIdentificacion" runat="server" style="height: 50px;">
                    <div style="float: left; width: 30%">
                        <asp:Label ID="Label2" runat="server" CssClass="il_lb_campos">Nombre Modulo</asp:Label>
                        <br />
            ...
            <div id="divGeneral" runat="server" style="margin-bottom: 15px;">
                ...
                <div id="FacturasPagoServicio">
                    <asp:DataGrid ID="dgGrupo" runat="server" Width="100%" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CellPadding="2" CellSpacing="1"
                        OnItemCommand="dgGrupo_ItemCommand" Caption='<tr class="trTitulo"><td class="titulo_grilla " colspan="9">Modulos</td></tr>' CssClass="tbGrilla">
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="id_Modulo" HeaderText="Codigo Grupo" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="NombreModulo" HeaderText="Nombre" ItemStyle-Width="30%" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
