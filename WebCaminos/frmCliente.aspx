<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="frmCliente.aspx.cs" Inherits="WebSISCON.frmCliente" %>
...
<asp:Content ID="Contenido" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>    
            ...
            <h1 id="h1" runat="server" class="titulos">Formulario de Registro de Clientes</h1>
                                        ...
                                        <ItemTemplate>
                                            <tr class="trSubTitulo_item uk-text-right uk-text-center@s">
                                                <td data-label="ID" class="uk-text-center@s">
                                                    <span class="Etiqueta">
                                                        <asp:Label ID="lblCodigo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "id_cliente") %>' />
                                                    </span>
                                                </td>
                                                <td data-label="Cliente" class="uk-text-left@s">
                                                    <span class="Etiqueta">
                                                        <asp:Label ID="Label3" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Nombre_cliente") %>' />
                                                    </span>
                                                </td>
                                                <td data-label="Tipo Persona" class="uk-text-left@s">
                                                    <span class="Etiqueta">
                                                        <asp:Label ID="lblNombres" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "descTipoPesona") %>' />
                                                    </span>
                                                </td>
                                                ...
                                                <td data-label="Editar">
                                                    <span class="Etiqueta">
                                                        <asp:LinkButton ID="lnkEditar" runat="server" CssClass="link_saldo" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id_cliente") %>'
                    ...
                    <div class="uk-margin-small">
                        <div uk-grid class="uk-grid-small">
                             <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label ID="Label6" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Nombre Cliente</asp:Label>
                                <asp:TextBox ID="txtNombreCliente" runat="server" CssClass="uk-input uk-form-small claseMonto uk-text-left">
                                </asp:TextBox>
                            </div>

                             <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label runat="server" CssClass="custom-dropdown">
                                    <asp:Label ID="Label17" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Tipo de Persona</asp:Label>
                                    <asp:DropDownList ID="cmbTipoPersona" runat="server" CssClass="customSelect uk-select uk-form-small" AppendDataBoundItems="true" >
                                        <asp:ListItem Value="-1">Seleccionar</asp:ListItem>
                                        <asp:ListItem Value="1">Persona Natural</asp:ListItem>
                                        <asp:ListItem Value="0">Persona Juridica</asp:ListItem>
                                    </asp:DropDownList>
                                </asp:Label>
                            </div>                           
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label ID="Label4" CssClass="il_lb_campos uk-form-label texto_15" runat="server">CI/NIT</asp:Label>
                        ...
                        <div uk-grid class="uk-grid-small">
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label ID="Label1" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Dirección</asp:Label>
                                <asp:TextBox ID="txtDireccion" runat="server" CssClass="uk-input uk-form-small claseMonto uk-text-left">
                                </asp:TextBox>
                            </div>
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label ID="Label2" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Teléfono</asp:Label>
                                <asp:TextBox ID="txtTelefono" runat="server" CssClass="uk-input uk-form-small claseMonto uk-text-left">
                                </asp:TextBox>
                            </div>
                            <div class="uk-width-1-2 uk-width-1-3@m">
                                <asp:Label ID="Label5" CssClass="il_lb_campos uk-form-label texto_15" runat="server">Mail</asp:Label>
                                <asp:TextBox ID="txtMail" runat="server" CssClass="uk-input uk-form-small claseMonto uk-text-left">
                                </asp:TextBox>
                            </div>
                        </div>
                        <div uk-grid class="uk-grid-small">
