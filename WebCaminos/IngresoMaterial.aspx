<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="IngresoMaterial.aspx.cs" Inherits="WebSISCON.IngresoMaterial" %>
...
<asp:Content ID="Contenido" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <h1 id="h1" runat="server" class="titulos">Ingreso de Material a Almacen</h1>
                        ...
                        <div class="uk-margin-small">
                            <div uk-grid class="uk-grid-small">
                                <div class="uk-width-1-2 uk-width-1-3@m">
                                    ...
                                    <asp:TextBox ID="txtNroPedido" runat="server" CssClass="uk-input uk-form-small uk-text-center" MaxLength="100">
                                    </asp:TextBox>
                                </div>
