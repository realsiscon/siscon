<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="frmLugarEntrega.aspx.cs" Inherits="WebSISCON.frmLugarEntrega" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <h1 id="hTitulo" class="titulos" style="margin-right: 10px; padding-top: 27px">Formulario de Registro de Lugares de Entrega</h1>
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false" Height="150px">
                <div id="DatosIdentificacion" runat="server" style="height: 50px;">
                    <div style="float: left; width: 30%">
                        <asp:Label ID="Label2" runat="server" CssClass="il_lb_campos">Nombre Lugar</asp:Label>
                        <br />
                        <asp:TextBox ID="txtLugarEntrega" runat="server" CssClass="il_txt_campos" Width="90%"></asp:TextBox>
                ...
                <br />
                <br />
                <asp:HiddenField ID="hddID_Lugar" runat="server" />
                <div style="float: left; width: 100%; text-align: center;">
                    <asp:Button ID="btnEnviar" CssClass="il_botones2" runat="server" Text="Guardar Lugar" OnClick="btnEnviar_Click" />
                </div>
            </asp:Panel>
            ...
            <div id="divGeneral" runat="server" style="margin-bottom: 15px;">
                ...
                <div id="FacturasPagoServicio">
                    <asp:DataGrid ID="dgLugaresEntrega" runat="server" Width="100%" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CellPadding="2" CellSpacing="1"
                        OnItemCommand="dgLugaresEntrega_ItemCommand" Caption='<tr class="trTitulo"><td class="titulo_grilla " colspan="9">Lugares Entrega</td></tr>' CssClass="tbGrilla">
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="ID_Lugar" HeaderText="ID Lugar" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Nombre_Lugar" HeaderText="Nombre Lugar" ItemStyle-Width="30%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
                            ...
                            <asp:TemplateColumn HeaderText="Editar" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                                <ItemTemplate>
                                    <%--<asp:ImageButton ID="chkImgEditar" CssClass="EditarRegistro" ImageUrl="~/Imagenes/check.png" runat="server" CommandName="Editar" ToolTip="Modificar Registro" />--%>
                                    <%--<asp:ImageButton ID="chkImgEditar" CssClass="EditarRegistro"  runat="server" CommandName="Editar" AlternateText=""  />--%>
        ...
        <Triggers>
            <%--<asp:AsyncPostBackTrigger ControlID="dgLugaresEntrega" EventName="dgLugaresEntrega_ItemCommand" />--%>
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
