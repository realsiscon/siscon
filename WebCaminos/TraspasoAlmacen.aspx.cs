...
namespace WebSISCON
{
    public partial class TraspasoAlmacen : Page
    {
        private static Transaccion _transaccion;

        private static Enums.TipoTransaccion tipoTransaccion = Enums.TipoTransaccion.Traspaso;
        ...
        protected void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (IntResultado == 0)
                    ucAlertas.CargarMensaje("Traspaso de Almacen Registrado exitosamente.", MensajeAlertas.Tipo.Exitoso);
                else
                    ucAlertas.CargarMensaje("Error al registrar el Traspaso.", MensajeAlertas.Tipo.Error);
