<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="frmObservaciones.aspx.cs" Inherits="WebSISCON.frmObservaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="updGeneral" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <h1 id="hTitulo" class="titulos" style="margin-right: 10px; padding-top: 27px">Formulario de Registro de Observaciones</h1>
            ...
            <asp:Panel ID="pnlRegistro" runat="server" Visible="false" Height="150px">
                <div id="DatosIdentificacion" runat="server" style="height: 50px;">
                    <div style="float: left; width: 30%">
                        <asp:Label ID="Label2" runat="server" CssClass="il_lb_campos">Observacion</asp:Label>
                        <br />
                        <asp:TextBox ID="txtObservacion" runat="server" CssClass="il_txt_campos" Width="90%"></asp:TextBox>
                ...
                <br />
                <br />
                <asp:HiddenField ID="hddID_Observacion" runat="server" />
            ...
            <div id="divGeneral" runat="server" style="margin-bottom: 15px;">
                ...
                <div id="FacturasPagoServicio">
                    <asp:DataGrid ID="dgObservaciones" runat="server" Width="100%" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CellPadding="2" CellSpacing="1"
                        OnItemCommand="dgObservaciones_ItemCommand" Caption='<tr class="trTitulo"><td class="titulo_grilla " colspan="9">Observaciones</td></tr>' CssClass="tbGrilla">
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="Cod_Observaciones" HeaderText="Codigo Observacion" ItemStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
                            <asp:BoundColumn DataField="Descripcion" HeaderText="Observacion" ItemStyle-Width="30%" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
